...
public class UniverseCanvasImpl extends SimpleCanvasImpl {

	private final Logger logger = Logger.getLogger(UniverseCanvasImpl.class.getName());
	...
	public UniverseCanvasImpl(int width, int height) {
		super(width, height);
	}
