...
public class PlayerConfig implements IPlayerConfig
{
	...
	public static <T extends IPlayerConfig> Set<T> select(SQLiteConnection conn, IGameConfig config, Class<T> expectedType, String where, Object ... params) throws SQLiteDBException
	{
		try
		{
