...
class DataBase implements Serializable
{
	...
	public genericResultSet<ProductiveCelestialBody, Unit, ABuilding> getBuilding(String celestialBodyName, String playerName, Class<? extends common.IBuilding> clientBuildingType)
	{
		ICelestialBody celestialBody = getCelestialBody(celestialBodyName);		
