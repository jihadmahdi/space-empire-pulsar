...
public class CarbonOrder implements ICarbonOrder
{
	...
	public static <T extends ICarbonOrder> Set<T> select(SQLiteConnection conn, IGameConfig config, Class<T> expectedType, String where, Object ... params) throws SQLiteDBException
	{
		try
		{
