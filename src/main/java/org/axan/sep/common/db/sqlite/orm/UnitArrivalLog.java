...
public class UnitArrivalLog implements IUnitArrivalLog
{
	...
	public static <T extends IUnitArrivalLog> Set<T> select(SQLiteConnection conn, IGameConfig config, Class<T> expectedType, String from, String where, Object ... params) throws SQLiteDBException
	{
		try
		{
