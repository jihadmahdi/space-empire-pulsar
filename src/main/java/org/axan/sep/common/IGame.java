...
public interface IGame
{
        ...
        {
                void endTurn(List<GameCommand<?>> commands) throws Throwable;
         ...
         */
        public abstract void resetTurn() throws GameBoardException;
         ...
         */
        public abstract void undo() throws GameBoardException;
         ...
         * @throws GameCommandException
         */
        public abstract void redo() throws GameBoardException;
         ...
         * @return
         */
        public abstract List<GameCommand<?>> getCommands();

        /**
         * End turn (after turn is ended, the game must reject any command including undo/redo.
         * @throws GameCommandException
         */
        public abstract void endTurn() throws GameBoardException;
