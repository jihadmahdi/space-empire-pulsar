...
public class LocalGame
{
	...
	{
		void endTurn(List<ILocalGameCommand> commands) throws Throwable;
	...
	private SortedMap<PlayerGameBoard, ILocalGameCommand> commands = new TreeMap<PlayerGameBoard, ILocalGameCommand>(new Comparator<PlayerGameBoard>()
			{
	...
	private Stack<ILocalGameCommand> undoneCommands = new Stack<ILocalGameCommand>();
	 ...
	 */
	public synchronized void executeCommand(ILocalGameCommand command) throws LocalGameCommandException
	{
	...
	private synchronized void reExecuteCommand(ILocalGameCommand command) throws LocalGameCommandException
	{
		if (turnEnded)
		{
			throw new LocalGameCommandException("Turn already ended.");
		}
	 ...
	 */
	public synchronized void resetTurn() throws LocalGameCommandException
	{
		AbstractGameCommandCheck check = canResetTurn();
		if (!check.isPossible())
		{
			throw new LocalGameCommandException(check.getReason());
		}
	...
	public synchronized void undo() throws LocalGameCommandException
	{
	...
	public synchronized void redo() throws LocalGameCommandException
	{
	 ...
	 * @return
	 */
	public List<ILocalGameCommand> getCommands()
	{
		return new LinkedList<ILocalGameCommand>(commands.values());		
	}
	...
	public synchronized void endTurn() throws LocalGameCommandException
	{
		...
		{
			throw new LocalGameCommandException(t);
		}
	...
	public static class AttackEnemiesFleet extends AbstractGameCommand<AttackEnemiesFleetParams, AttackEnemiesFleetCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(AttackEnemiesFleetCheck check) throws LocalGameCommandException
		{
	...
	public static class Build extends AbstractGameCommand<BuildParams, BuildCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(BuildCheck check) throws LocalGameCommandException
		{
			try
			{
			...
			{
				throw new LocalGameCommandException(e);
			}
	...
	public static class Demolish extends AbstractGameCommand<DemolishParams, DemolishCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(DemolishCheck check) throws LocalGameCommandException
		{
	...
	public static class DismantleFleet extends AbstractGameCommand<DismantleFleetParams, DismantleFleetCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(DismantleFleetCheck check) throws LocalGameCommandException
		{
			try
			{
	...
	public static class SettleGovernment extends AbstractGameCommand<SettleGovernmentParams, SettleGovernmentCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(SettleGovernmentCheck check) throws LocalGameCommandException
		{
	...
	public static class FireAntiProbeMissile extends AbstractGameCommand<FireAntiProbeMissileParams, FireAntiProbeMissileCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(FireAntiProbeMissileCheck check) throws LocalGameCommandException
		{
	...
	public static class LaunchProbe extends AbstractGameCommand<LaunchProbeParams, LaunchProbeCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(LaunchProbeCheck check) throws LocalGameCommandException
		{
	...
	public static class EmbarkGovernment extends AbstractGameCommand<EmbarkGovernmentParams, EmbarkGovernmentCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(EmbarkGovernmentCheck check) throws LocalGameCommandException
		{
	...
	public static class MakeStarships extends AbstractGameCommand<MakeStarshipsParams, MakeStarshipsCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(MakeStarshipsCheck check) throws LocalGameCommandException
		{
			check.planet.setCarbon(check.planet.getCarbon() - check.carbonCost);
			check.planet.setPopulation(check.planet.getPopulation() - check.populationCost);
	...
	public static class FormFleet extends AbstractGameCommand<FormFleetParams, FormFleetCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(FormFleetCheck check) throws LocalGameCommandException
		{
	...
	public static class MakeProbes extends AbstractGameCommand<MakeProbesParams, MakeProbesCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(MakeProbesCheck check) throws LocalGameCommandException
		{
			check.planet.setCarbon(check.planet.getCarbon() - check.carbonCost);
			check.planet.setPopulation(check.planet.getPopulation() - check.populationCost);
	...
	public static class MakeAntiProbeMissiles extends AbstractGameCommand<MakeAntiProbeMissilesParams, MakeAntiProbeMissilesCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(MakeAntiProbeMissilesCheck check) throws LocalGameCommandException
		{
			check.planet.setCarbon(check.planet.getCarbon() - check.carbonCost);
			check.planet.setPopulation(check.planet.getPopulation() - check.populationCost);
	...
	public static class DemolishSpaceRoad extends AbstractGameCommand<DemolishSpaceRoadParams, DemolishSpaceRoadCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(DemolishSpaceRoadCheck check) throws LocalGameCommandException
		{
	...
	public static class BuildSpaceRoad extends AbstractGameCommand<BuildSpaceRoadParams, BuildSpaceRoadCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(BuildSpaceRoadCheck check) throws LocalGameCommandException
		{
	...
	public static class ModifyCarbonOrder extends AbstractGameCommand<ModifyCarbonOrderParams, ModifyCarbonOrderCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(ModifyCarbonOrderCheck check) throws LocalGameCommandException
		{
	...
	public static class ChangeDiplomacy extends AbstractGameCommand<ChangeDiplomacyParams, ChangeDiplomacyCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(ChangeDiplomacyCheck check) throws LocalGameCommandException
		{
	...
	public static class MoveFleet extends AbstractGameCommand<MoveFleetParams, MoveFleetCheck> implements Serializable
	{
		...
		@Override
		protected PlayerGameBoard apply(MoveFleetCheck check) throws LocalGameCommandException
		{
